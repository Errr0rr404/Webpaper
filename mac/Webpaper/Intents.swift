...
struct RemoveWebsitesIntent: AppIntent {
	...
	static let description = IntentDescription("Removes the given websites from Webpaper.")
...
struct SetEnabledStateIntent: AppIntent {
	...
	static let description = IntentDescription("Sets the enabled state of Webpaper.")
	...
	static var parameterSummary: some ParameterSummary {
		When(\.$shouldToggle, .equalTo, true) {
			Summary("\(\.$shouldToggle) Webpaper")
		} otherwise: {
			Summary("\(\.$shouldToggle) Webpaper \(\.$isEnabled)")
		}
	}
...
struct GetEnabledStateIntent: AppIntent {
	...
	static let description = IntentDescription(
		"Returns whether Webpaper is currently enabled.",
		resultValueName: "Enabled State"
	)

	static var parameterSummary: some ParameterSummary {
		Summary("Get the current enabled state of Webpaper")
	}
...
struct GetCurrentWebsiteIntent: AppIntent {
	...
	static let description = IntentDescription(
		"Returns the current website in Webpaper.",
...
struct SetCurrentWebsiteIntent: AppIntent {
	...
	static let description = IntentDescription("Sets the current website in Webpaper to the given website.")
...
struct ReloadWebsiteIntent: AppIntent {
	...
	static let description = IntentDescription("Reloads the current website in Webpaper.")
...
struct NextWebsiteIntent: AppIntent {
	...
	static let description = IntentDescription("Switches Webpaper to the next website in the list.")
...
struct PreviousWebsiteIntent: AppIntent {
	...
	static let description = IntentDescription("Switches Webpaper to the previous website in the list.")
...
struct RandomWebsiteIntent: AppIntent {
	...
	static let description = IntentDescription("Switches Webpaper to a random website in the list.")
...
struct ToggleBrowsingModeIntent: AppIntent {
	...
	static let description = IntentDescription("Toggles “Browsing Mode” for Webpaper.")
...
extension WebsiteAppEntity {
	struct Query: EnumerableEntityQuery, EntityStringQuery {
		static let findIntentDescription = IntentDescription(
			"Returns the websites in Webpaper.",
