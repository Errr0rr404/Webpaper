...
enum SSApp {
	...
	static func openSendFeedbackPage() {
		...
		URL("https://github.com/Errr0rr404/Webpaper/issues")
...
Test it with a page that calls `alert`, `confirm`, and `prompt`.
...
extension URL {
	/**
	Human-friendly representation of the URL: `https://example.com/` → `example.com`.
	*/
...
extension URL {
	...
	```
	URL(humanString: "example.com")?.absoluteString
	//=> "https://example.com"
	```
	*/
