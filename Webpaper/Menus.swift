...
extension AppState {
	...
	private func createMoreMenu() -> SSMenu {
		...
		menu.addLinkItem("Send Feedback…", destination: "https://github.com/Errr0rr404/Webpaper/issues")

		menu.addSeparator()

		menu.addLinkItem("Tips", destination: "https://github.com/Errr0rr404/Webpaper#tips")

		menu.addLinkItem("FAQ", destination: "https://github.com/Errr0rr404/Webpaper#faq")

		menu.addLinkItem("Scripting", destination: "https://github.com/Errr0rr404/Webpaper#scripting")

		menu.addLinkItem("Source Code", destination: "https://github.com/Errr0rr404/Webpaper")
	...
	private func addWebsiteItems() {
		...
		if !WebsitesController.shared.all.isEmpty {
				...
				website.url.normalized() != url
			{
				...
				menuItem.toolTip = "Updates the URL for the stored website in Webpaper to the current URL"
			}
